...
dotnet publish DiscoCartUtil/DiscoCartUtil.csproj /p:Configuration=Release /p:Platform="Any CPU" /p:OutputPath=../bin/Release/net8.0/ -r linux-arm64 --self-contained
